...
A Feladat: Promptold az LLM-et, hogy egy konkrét történelmi személyként viselkedjen (pl. Leonardo da Vinci).

Informatikai Fókusz: Iteratív Promptolás. A diákoknak finomítaniuk kell a "rendszer promptot" hogy tartalmazzon specifikus korlátozásokat, mint például 16. századi szókincs vagy utalások konkrét találmányokra.
...
A Feladat: Generálj egy verset egy meghatározott stílusban (pl. Romantika) egy modern technikai témáról, mint a kiberbiztonság.
...
Feladat: Foglalj össze egy Shakespeare drámát a főszereplők nevének vagy a "tragédia" szó használata nélkül.
...
Prompt Kihívás: A diákok leírnak egy jelenetet a Második Világháborúból, a reneszánsz Firenzéből vagy az Ókori Rómából, beleértve az építészeti részleteket, öltözködési stílusokat és légköri elemeket.
...
Prompt Kihívás: Tervezz borítókat klasszikusokhoz, mint az "1984", a "Büszkeség és Balítélet" vagy az "Átváltozás", csak szimbolikus és atmoszférikus elemeket használva.
...
Prompt Kihívás: Generálj egy 30 másodperces darabot, amely barokk udvari zenének, 1920-as évekbeli jazznek, középkori népzenének vagy film noir atmoszférának hangzik.
